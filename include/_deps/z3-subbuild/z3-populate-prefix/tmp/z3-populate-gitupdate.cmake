...
execute_process(
  COMMAND "/usr/bin/git" show-ref z3-4.12.1
  WORKING_DIRECTORY "/home/msi/mockturtle-master/include/_deps/z3-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/z3-4.12.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "z3-4.12.1")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "z3-4.12.1")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 z3-4.12.1
  WORKING_DIRECTORY "/home/msi/mockturtle-master/include/_deps/z3-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/Z3Prover/z3'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/msi/mockturtle-master/include/_deps/z3-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/msi/mockturtle-master/include/_deps/z3-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
